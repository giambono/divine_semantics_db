...
# Load Italian model if working with original text
nlp = spacy.load("it_core_news_sm")

text = """
Nel mezzo del cammin di nostra vita mi ritrovai per una selva oscura, ché la diritta via era smarrita.
Ahi quanto a dir qual era è cosa dura esta selva selvaggia e aspra e forte che nel pensier rinova la paura! </span>
...
# Extract entities
for ent in doc.ents:
    if ent.label_ in ["PER", "ANIMAL"]:  # Depends on model/entity set
